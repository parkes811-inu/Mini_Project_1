...
<%
	...
	boolean storeSuccess = cartDao.complete(tableNo, point, payment, phoneNum);
	boolean initSuccess = cartDao.initBasket(tableNo);
    
    // 결과에 따라 응답 설정
    response.setContentType("text/plain");
    response.setCharacterEncoding("UTF-8");
    if (storeSuccess == true && initSuccess == true) {
